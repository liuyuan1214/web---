/*编辑*/
<template>
    <el-form ref="form" :model="form" label-width="130px" class="form cpwh-edit" status-icon>
      <div class="form-title f-fs18  f-tac f-mb30 f-mt30">加工包装信息详情</div>
      ...
      <el-form-item label="包装类型" prop="packType">
          <el-radio v-model.trim="form.packType" :label="1" :disabled="true">加工包装</el-radio>
          <el-radio v-model.trim="form.packType" :label="2" :disabled="true">分拣包装</el-radio>
      </el-form-item>
      <el-form-item label="包装成品名称" prop="ncpmc" class="f-pr">
          <el-input v-model.trim=form.ncpmc readonly><span slot="suffix" class="f-fs24 f-pr10">···</span></el-input>
     ...
     <!-- <el-form-item :label="form.dw?`成品数量(${form.dw})`:`成品数量`" prop="packToProductNum">
        <el-input type="number" readonly v-positiveNumber v-model.trim="form.packToProductNum" placeholder="请输入" :maxlength="13"></el-input>
      </el-form-item>-->
	    <el-form-item label="成品数量" prop="packToProductNum" class="f4">
      <el-input v-model.trim="form.packToProductNum" @input="(value)=>{$nextTick(()=>{form.csl= String(value).slice(0,10)})}" placeholder="请输入" type="number" readonly>
      ...
      <el-form-item label="农产品名称" prop="ncpYlmc" class="f-pr">
          <el-input  :disabled="form.ncpmc?false:true"  readonly v-model.trim=form.ncpYlmc><span slot="suffix" class="f-fs24 f-pr10">···</span></el-input>
          <!-- <div class="f-pa" @click="form.ncpmc?jcncpDialogVisable=true:''"  style="top:0;right:0;left:0;bottom:0;opacity:0;"></div> -->
      </el-form-item>
      <el-form-item label="原料批次" prop="zzpc">
        <el-input v-model.trim="form.zzpc"  readonly  ></el-input>
      </el-form-item>
      <!--<el-form-item label="原料余量(斤)" prop="syl">
        <el-input type="number" v-positiveNumber v-model.trim="form.syl"  readonly ></el-input>
      </el-form-item>-->
	      <el-form-item label="原料余量" prop="syl" class="f4">
        <el-input  v-model.trim="form.syl" type="number"   readonly>
        <template slot="append" v-if="form.ncpdw">{{form.ncpdw}}</template>
      </el-input>
    </el-form-item>
	    <el-form-item label="使用原料数量" prop="packNum" class="f4">
      <el-input v-model.trim="form.packNum" placeholder="请输入" type="number" readonly>
        <template slot="append" v-if="form.ncpdw">{{form.ncpdw}}</template>
      </el-input>
    </el-form-item>
     <!-- <el-form-item label="使用原料数量(斤)" prop="packNum">
        <el-input type="number" v-positiveNumber readonly v-model.trim="form.packNum" placeholder="请输入" :maxlength="13" ></el-input>
      </el-form-item>-->
      <el-form-item label="配料及添加剂"  v-if="form.packType==1">
         <el-input type="textarea" readonly :autosize="{ minRows: 3, maxRows: 10}" v-model.trim="form.yl" placeholder="请输入" :maxlength="128"></el-input>
      </el-form-item>
      <el-form-item label="加工方法"  prop="handleWay" v-if="form.packType==1">
         <el-input type="textarea" readonly :autosize="{ minRows: 3, maxRows: 10}" v-model.trim="form.handleWay" placeholder="请输入" :maxlength="128"></el-input>
      </el-form-item>
      <el-form-item label="产品等级" prop="produceLevel">
        <el-input v-model.trim="form.produceLevel"  readonly placeholder="请输入" :maxlength="30"></el-input>
      </el-form-item>
      ...
      <el-form-item label="备注">
         <el-input type="textarea"  readonly :autosize="{ minRows: 3, maxRows: 10}" v-model.trim="form.remark" placeholder="请输入" :maxlength="128"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    data(){
      ...
      return {
        ...
        rules:{
            ...
            ypmc:commonValidate,
            zzpc:commonValidate,
			produceLevel:commonValidate,
			handleWay:commonValidate,

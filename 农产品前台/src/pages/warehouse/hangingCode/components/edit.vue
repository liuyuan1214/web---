...
<template>
    <el-form ref="form" :model="form" label-width="120px" class="form cpwh-edit" :rules="rules" status-icon>
      ...
      <el-form-item label="挂码类型" prop="gmlx">
          <el-radio v-model.trim="form.gmlx" label="1" @change="gmlxChange" :disabled="form.id?true:false">包装挂码</el-radio>
      ...
      <el-form-item label="开始身份码" prop="codeStart">
        <el-input v-model.trim="form.codeStart"  v-positiveNumber placeholder="请输入12位身份码" :maxlength="12" show-word-limit></el-input>
      </el-form-item>
      <el-form-item label="结束身份码" prop="codeEnd">
        <el-input v-model.trim="form.codeEnd"  v-positiveNumber  placeholder="请输入12位身份码" :maxlength="12" show-word-limit></el-input>
      </el-form-item>

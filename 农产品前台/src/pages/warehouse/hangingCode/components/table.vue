...
<template>
   <div>
    ...
    <div class="tabs  f-df f-cp">
      <div :class="[currentTab==1?'tab-active':'','tab-item']" @click="currentTab=1">基地生产挂码</div>
      <div :class="[currentTab==2?'tab-active':'','tab-item']"  @click="currentTab=2">外来采购挂码</div>
    </div>
    <!-- tab1 -->
          ...
          <div>
             ...
             <date-picker @selChange="(val)=>{query2.selDateRange=val}" style="vertical-align:bottom"></date-picker> 
              ...
              <el-select  v-model.trim="query2.lx" size="small" class=" f-mr20 f-vab" placeholder="请选择" style="vertical-align:bottom"  @change=search2>
                <el-option value="" label="全部"></el-option>
                <el-option value="1" label="包装挂码"></el-option>
                <el-option value="2" label="采购挂码"></el-option>
            </el-select>
        ...
        data(){
            return {
                ...
                tableHeader1:[
                  ...
                  {label:'类型',prop:'gmlx',formatter(val){return val==1?'包装挂码':'采收挂码'}},
                  {label:'备注',prop:'bz'},
                ...
                tableHeader2:[
                  ...
                  {label:'类型',prop:'gmlx',formatter(val){return val==1?'包装挂码':'采购挂码'}},
                  {label:'备注',prop:'bz'},

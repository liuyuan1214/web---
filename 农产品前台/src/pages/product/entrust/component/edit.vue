    ...
    <el-form ref="form" :model="form" label-width="120px" class="form cpwh-edit" :rules="rules" status-icon>
      ...
      <el-form-item label="报告日期" prop="testDate" >
            <el-date-picker
              ...
              placeholder="选择日期" :disabled="form.bgly==3">
          </el-date-picker>
      </el-form-item>
      ...
      <el-form-item label="报告编号" prop="testSno">
        <el-input v-model.trim="form.testSno" placeholder="请输入" :maxlength="32" show-word-limit :disabled="form.bgly==3" ></el-input>
      </el-form-item>
      <el-form-item label="检测机构" prop="testCompanyName">
        <el-input v-model.trim="form.testCompanyName" placeholder="请输入" :maxlength="32" show-word-limit :disabled="form.bgly==3"></el-input>
      </el-form-item>
      <el-form-item label="图片" prop="attaUrl">
        <el-upload
         ...
         :before-upload="beforeAvatarUpload"
          ...
          action="''"
          :auto-upload="true"
          :class="{disabled:form.bgly==3}"
          :disabled="form.bgly==3"
          name="clientFile"
        ...
        <span v-if="form.bgly==1">备注：最多上传9张，支持jpg，png格式图片</span>
      </el-form-item>

<template>
  <el-form ref="form" :model="form" label-width="120px" class="form cpwh-edit" :rules="rules" status-icon>
    ...
    <el-form-item label="选择批次" prop="zzpc" class="f-pr">
      <el-input  v-model=form.zzpc><span slot="suffix" class="f-fs24 f-pr10">···</span></el-input>
...
<!--    <el-form-item label="采收批次号" prop="cspch" class="f-pr" v-show="form.gmlx == '1'||form.gmlx == '2'" >-->
<!--      <el-input  v-model=form.cspch disabled></el-input>-->
<!--    </el-form-item>-->
<!--    <el-form-item label="包装批次号" prop="bzpc" class="f-pr" v-show="form.gmlx == '1'||form.gmlx == '4'" >-->
...
<!--    </el-form-item>-->
    ...
    <el-form-item label="联系方式" prop="lxfs" class="f-pr">
      <el-input  v-model=form.lxfs onkeyup="this.value=this.value.replace(/[^\d]/g,'');" maxlength="11"></el-input>
    </el-form-item>
...
<!--    </el-form-item>-->
    ...
    <el-form-item>
      <el-button round type="primary" @click=submitForm :disabled="disabled">{{disabled?'打印中':'打 印'}}</el-button>
    ...
    <el-dialog
      title="选择批次"
      width="900px"
      :visible.sync="zzpcDialogVisable"
    >
...
<script>
  ...
  export default {
    ...
    data(){
      ...
      const commonValidateChange = {required: true, message: '必选项', trigger: 'change'}
        ...
        this.$refs.form.validate(async (valid) => {
          if (valid) {
            ...
            fetch({
              ...
              var timearr = res.bean.kjrq.replace(" ", ":").replace(/\:/g, "-").split("-");
              var timestr = timearr[0]+"年"+ Number(timearr[1])+ "月" + timearr[2]+"日";

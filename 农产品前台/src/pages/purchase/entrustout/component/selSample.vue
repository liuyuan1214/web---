...
<template>
   <div style="padding-bottom:70px;min-height:470px;">
     ...
     <div class="header f-df f-pr20">
       <div>
          <el-input :placeholder="'样品名称\\供货商名称\\批次号'" style="vertical-align:bottom"  @keyup.enter.native=getTableData v-model.trim=searchkey class="input-with-select"  size="small">
          </el-input> 
    ...
    export default {
        ...
        */
        getTableData(obj={pageSize:10,pageNo:1}){
          ...
          var query = {
            method:'get',
            url:'/cggl/cg/pagePurchDetailAndPack/',
            data:params  
          }

...
<template>
   <div class="dkfzr" style="padding-bottom:70px;min-height:470px;">
     ...
     <div class="header f-df f-pr20">
       <div>
          <el-input placeholder="供应商名称"  @keyup.enter.native=search v-model.trim=khmc class="input-with-select f-vab"  size="small">
          </el-input> 
    ...
    export default {
        ...
        data(){
            return {
                ...
                //table参数
                tableHeader:[
                  {label:'供应商名称',prop:'khmc'},
                  {label:'供应商简称',prop:'khjc'},
                  {label:'联系人',prop:'lxr'},

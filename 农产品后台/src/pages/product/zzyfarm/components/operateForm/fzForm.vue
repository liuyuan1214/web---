...
<template>
  <el-form
    ...
    status-icon
  >
    <div class="form-title f-fs18 f-tac f-mb30 f-mt30">{{form.id?'编辑':'新增'}}病虫害防治信息</div>
    ...
    <el-form-item label="安全间隔期（天）" prop="aqjgq" class="f4">
      <el-input v-model.trim="form.aqjgq" placeholder="请输入" :maxlength="20" show-word-limit type="number"></el-input>
    </el-form-item>
    <el-form-item label="用量" prop="yl" class="f4">

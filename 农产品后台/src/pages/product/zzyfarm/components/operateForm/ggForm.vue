...
<template>
  <el-form ref="form" :model="form" label-width="100px" class="form cpwh" :rules="rules" status-icon>
    <div class="form-title f-fs18  f-tac f-mb30 f-mt30">{{form.id?'编辑':'新增'}}灌溉信息</div>
    ...
    <el-form-item label="灌溉日期" prop="fsrq">
      <el-date-picker
  ...
  export default {
    ...
    methods: {
      ...
      beforeAvatarUpload(file) {
        const isJPG = file.type === 'image/jpeg' || file.type === 'image/jpg' || file.type === 'image/png'|| file.type === 'image/JPG';

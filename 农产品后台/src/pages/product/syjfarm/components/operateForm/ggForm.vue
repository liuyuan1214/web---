...
<template>
  <el-form ref="form" :model="form" label-width="100px" class="form cpwh" :rules="rules" status-icon>
    <div class="form-title f-fs18  f-tac f-mb30 f-mt30">{{form.id?'编辑':'新增'}}浇水信息</div>
    ...
    <el-form-item label="浇水日期" prop="fsrq">
      <el-date-picker
    ...
    <el-form-item label="作业描述" prop="nr">
      <el-input type="textarea" :autosize="{ minRows: 3, maxRows: 10}" v-model.trim="form.nr" placeholder="请输入"

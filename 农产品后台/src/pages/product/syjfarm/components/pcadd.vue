...
<template>
    <el-form ref="form" :model="form" label-width="120px" class="form cpwh-edit" :rules="rules" status-icon>
      ...
      <el-form-item label="起批日期" prop="qprq" >
            <el-date-picker
      ...
      <el-form-item label="地块名称" prop="csmc" class="f-pr">
      ...
      <el-form-item label="种植日期" prop="zzrq" >
            <el-date-picker
        ...
        <el-form-item label="种植作物" prop="ncpmc" class="f-pr">
	  ...
	  <el-form-item label="品种" prop="trpdm">
        ...
        <el-form-item label="种植面积(亩)" prop="zzmj">
        <el-input v-model.trim="form.zzmj" type="number" placeholder="请输入"></el-input>
      </el-form-item>
      <el-form-item label="种植方式" prop="zzfs">
        <el-input v-model.trim="form.zzfs" placeholder="请输入"></el-input>
      </el-form-item>
      <el-form-item label="种植量(每亩)" prop="zzl">
        <el-input v-model.trim="form.zzl" type="number" placeholder="请输入"></el-input>
      </el-form-item>
      ...
      <el-form-item label="预收量(斤)" prop="ysl">
        <el-input v-model.trim="form.ysl" type="number" placeholder="请输入" ></el-input>
      </el-form-item>
    ...
    data(){
      ...
      return {
        ...
        rules:{
            ...
            ysrq:commonValidateChange,
			zzmj:commonValidateChange,
            ysl:commonValidate
        }
      }
    },

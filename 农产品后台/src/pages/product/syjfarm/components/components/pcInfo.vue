  ...
  <div class="f-df border">
    ...
    <div :class="['pcinfo',isEdit?'':'editPcInfo']">
      ...
      <div>
        ...
        <el-input
          class="input-item"
          v-if="form.zzmj  || isEdit"
          placeholder="请输入"
          v-model.trim="form.zzmj"
          clearable
          :readonly="!isEdit"
        />
        <el-input
      ...
      <div>
        ...
        <el-input
          class="input-item"
          v-if="form.zzfs  || isEdit"
          placeholder="请输入"
          v-model.trim="form.zzfs"
          clearable
          :readonly="!isEdit"
        />
      </div>
      <div>
        ...
        <el-input
          class="input-item"
          v-if="form.zzl  || isEdit"
          placeholder="请输入"
          v-model.trim="form.zzl"
          clearable
          :readonly="!isEdit"
        />
      </div>
      <div>
        ...
        <el-input
          class="input-item"
          v-if="form.ysl  || isEdit"
          placeholder="请输入"
          v-model.trim="form.ysl"
          clearable
          :readonly="!isEdit"
        />
          <el-input
    ...
    <div class="f-df edit-btn" sw-mode="y" v-if="pageName && form.zt==1">
      ...
      <div class="f-f1" style="line-height:108px;color:#ff3333">

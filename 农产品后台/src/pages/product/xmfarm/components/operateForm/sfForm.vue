...
<template>
    <el-form ref="form" :model="form" label-width="100px" class="form cpwh" :rules="rules" status-icon>
      <div class="form-title f-fs18  f-tac f-mb30 f-mt30">{{form.sfjlId?'编辑':'新增'}}喂料信息</div>
      ...
      <el-form-item label="喂料日期" prop="sfrq">
            <el-date-picker
      ...
      <el-form-item label="饲料名称" prop="trpmc" class="f-pr f4">
          <el-input  v-model.trim=form.trpmc><span slot="suffix" class="f-fs24 f-pr10">···</span></el-input>
          <div class="f-pa" @click="trpDialogVisable=true" style="top:0;right:0;left:0;bottom:0;opacity:0;"></div>
      </el-form-item>
      <el-form-item label="用量" prop="yljff" >
        <el-input v-model.trim="form.yljff" placeholder="请输入" ></el-input>
      </el-form-item> 
      <el-form-item label="喂料人" prop="sfr">
        <el-input v-model.trim="form.sfr" placeholder="请输入" :maxlength="20" ></el-input>
      </el-form-item>     	  

...
<template>
  <div style="padding-bottom:70px;min-height:470px;">
    ...
    ></s-table>
    <el-dialog title="新增养殖产品" :append-to-body="true" :visible.sync="isAddSample" width="800px" :before-close="refreshData">
	  <add-sample style="margin:0 auto;" v-if="isAddSample" @close="isAddSample=false"></add-sample>
    </el-dialog>
  </div>
</template>

...
<script>
    ...
    export default {
        data(){
            return {
                ...
                tableHeader1:[
                  ...
                  {label:'所处阶段',prop:'scjd'},
                  {label:'生产周期',prop:'sczq'},
                  {label:'空气温度',prop:'kqsd'},
                  {label:'湿度',prop:'sd'},
                  {label:'二氧化碳浓度',prop:'eyhtnd'},
                  {label:'光照度',prop:'gzd'},
                  {label:'土壤温度',prop:'trwd'},
       ...
       /*render-column开始*/
        ...
        renderTrpEdit(h,row){
          return (
                <el-button size="mini"  type="info" plain onClick={()=>{this.$emit('edit',row,'1')}}>领用开单</el-button> 
          )
        },
       /*render-column结束*/
        search1(){

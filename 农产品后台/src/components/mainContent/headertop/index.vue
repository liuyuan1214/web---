<template>
  <div id="app-head" class="f-select-not">
    <!-- 左边的logo -->
    <router-link to="/home" class="left bg-main f-autoCont">
    ...
    <div class="right" :style="{background:'url(./static/headerbg/bg'+userInfo.nyVersion+'.png)'}">
      <div class="content f-df" sw-align="center">
        ...
        <div class="f-cp sys-info">
          <el-badge :value="unreadNotice">
            <span class="f-fs18" @click="$router.push({path:'/notice'})">公告通知</span>
          </el-badge>
        </div>
        <!-- 用户中心:退出登录，修改密码 -->
        <user-info></user-info>
